...
class GameSettingsPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final items = [
      ...
      (
        title: confirmDelete.value ? "Are you sure? Delete cannot be reversed." : "Delete Game",
        subtitle: null as String?,
        trailing: null as Widget?,
                    ...
                    child: Material(
                      ...
                      child: ListTile(
                        ...
                        title: Text(
                          item.title,
                          style: TextStyle(
                            color: isSelected ? Colors.black : (index == 5 && confirmDelete.value ? Colors.red : Colors.white),
